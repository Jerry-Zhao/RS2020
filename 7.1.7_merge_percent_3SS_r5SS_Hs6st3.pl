#! /usr/local/perl -w
#
open(INA,"Result/05_motif/Hs6st3_intron1_nonRS_20up_percent.xls")||die("Can't open INA:$!\n");
open(INB,"Result/07_predict/Hs6st3_nonRS_18AGGT1_MaxEntScan_score.txt")||die("Can't open INB:$!\n");
open(INC,"Result/07_predict/Hs6st3_nonRS_r5SS_3upGT4_MaxEntScan_score.txt")||die("Can't open INC:$!\n");
open(OUT,">Result/07_predict/Merged_Hs6st3_nonRS_percent_3SS_5SS.xls")||die("Can't write OUT:$!\n");
